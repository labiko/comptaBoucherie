...
import { HistoriqueInvendus } from '../components/HistoriqueInvendus';
...
type TabType = 'encaissements' | 'factures' | 'invendus' | 'fournisseurs' | 'categories' | 'email' | 'tracabilite' | 'export';
  ...
  return (
    <div className="administration-container">
      ...
      <div className="tabs-container">
        ...
        {isBoulangerie && (
          <button
            className={`tab-button ${activeTab === 'invendus' ? 'active' : ''}`}
          ...
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M9 9h6M9 13h6M9 17h6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            Invendus
          </button>
        )}
      ...
      <div className="tab-content">
        ...
        {activeTab === 'invendus' && <HistoriqueInvendus />}
